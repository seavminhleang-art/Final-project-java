...
public class UserRepository {
    ...
    public Optional<User> findByEmail(String email) {
        ...
        String sql = "SELECT id, email, username, password_hash, full_name, role, is_enabled, created_at, updated_at " +
    ...
    public List<User> findAll(String search, Role role) {
        ...
        StringBuilder sql = new StringBuilder(
                "SELECT id, email, username, password_hash, full_name, role, is_enabled, created_at, updated_at FROM users WHERE 1=1"
        );
    ...
    public boolean create(User user) {
        ...
        String sql = "INSERT INTO users (email, username, password_hash, full_name, role, is_enabled) " +
                     "VALUES (?, ?, ?, ?, ?, ?)";
        try (Connection conn = DatabaseConnection.getConnection();
    ...
    public boolean update(User user) {
        String sql = "UPDATE users SET full_name = ?, role = ?, is_enabled = ?, updated_at = NOW() WHERE id = ?";
        try (Connection conn = DatabaseConnection.getConnection();
             PreparedStatement stmt = conn.prepareStatement(sql)) {
